      ...
      <div className="w-full min-h-[80vh] bg-linear-to-r from-[#fffade] to-[#FFFCEF] px-5 md:px-15 lg:px-25">
        <div className="pt-5 md:pt-0">
          ...
          <header className="flex justify-between items-center py-5 font-semibold">
            <div className="text-[18px] sm:text-[22px]">Interview Prep AI</div>
            <button
          ...
          <div className="flex md:flex-row flex-col gap-3">
            <div className="md:w-1/2 md:py-15 pt-10 pb-5">
              ...
              <h1 className="text-5xl font-medium mt-5">
                Ace Interviews with
                <br />
                <span className="text-transparent bg-clip-text bg-[radial-gradient(circle,_#ff9324_0%,_#fcd760_100%)] bg-[lengthh:200%_200%] animate-text-shine">
                  AI-Powered
                </span>{" "}
                Learning
              </h1>
            ...
            <div className=" md:w-1/2 md:py-15 py-5">
              <p className="mb-10">
                ...
                frontend concepts or refining your behavioral storytelling, our
                AI coach adapts to your unique pace, helping you bridge the gap
                between your current expertise and your next big breakthrough.
              </p>
              <button
